...
int main()
{
    ...
    case 1:
        ...
        if (choice2 == 1)
        {
            ...
            scanf("%d", &nodevalue);
            insert_at_head(&head, create_node(nodevalue));
            printlist(head);
            return 0;
        }
        else if (choice2 == 2)
        {
            ...
            insert_at_end(temp2, create_node(nodevalue));
            printlist(head);
            return 0;
        }
        else if (choice2 == 3)
        {
            ...
            scanf("%d", &searchval);
            temp1 = find_node(head, searchval);
            printf("\nEnter the value of node: ");
            scanf("%d", &nodevalue);
            insert_random(temp1, create_node(nodevalue));
            printlist(head);
            return 0;
        }
        else
